...
class B2TrackerHit : public G4VHit
{
  public:
    ...
    void SetGlobalTime (G4double time) {fGlobalTimestamp = time;};
    void SetProcessName (G4String ProcessName)	{ fProcessName = ProcessName; };
    void SetProcessNamePreStep (G4String ProcessNamePreStep)	{ fProcessNamePreStep = ProcessNamePreStep; };
    ...
    void SetPreKineticEnergy (G4double PreKineticEnergy) {fPreKineticEnergy = PreKineticEnergy;};
    // Get methods
    ...
    G4double GetGlobalTime() const     { return fGlobalTimestamp; };
    G4String GetProcessName() const { return fProcessName; };
    G4String GetProcessNamePreStep() const { return fProcessNamePreStep; };
  ...
  private:
      ...
      G4double      fEdep;
      G4ThreeVector fPos;
      G4double      fGlobalTimestamp;
      G4String	    fProcessName;
      G4String	    fProcessNamePreStep;
