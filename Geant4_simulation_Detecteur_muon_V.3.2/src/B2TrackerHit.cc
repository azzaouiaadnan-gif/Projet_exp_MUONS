...
{ 
  ...
  fProcessNamePreStep = right.fProcessNamePreStep;
  fTrackID   = right.fTrackID;
  fChamberNb = right.fChamberNb;
  fEdep      = right.fEdep;
  fPos       = right.fPos;
  fGlobalTimestamp = right.fGlobalTimestamp;
  fKineticEnergy = right.fKineticEnergy;
  //fTotalEnergy = right.fTotalEnergy;
  //fTrackLength = right.fTrackLength;
  fPreKineticEnergy = right.fPreKineticEnergy;
}
...
//....oooOO0OOooo......ParticleName..oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
...
{
/*  G4cout << "  trackID: " << fTrackID << " Particle Name: " << fParticleName << " time: " << fGlobalTimestamp << " CreatorProcess: " << fProcessName << " ProcessStep: " << fProcessNamePreStep
  << " KineticEnergy: " << fKineticEnergy
   << G4endl;  
<< " Edep: "
