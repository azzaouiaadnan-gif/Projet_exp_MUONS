...
{  
  ...
  if(aStep->GetTrack()->GetCreatorProcess() && aStep->GetTrack()->GetCreatorProcess()->GetProcessName()){  
	newHit->SetProcessName (aStep->GetTrack()->GetCreatorProcess()->GetProcessName());
  }
  if(aStep->GetPreStepPoint() && aStep->GetPreStepPoint()->GetProcessDefinedStep() && aStep->GetPreStepPoint()->GetProcessDefinedStep()->GetProcessName()){  
  	newHit->SetProcessNamePreStep (aStep->GetPreStepPoint()->GetProcessDefinedStep()->GetProcessName());
  }
  newHit->SetKineticEnergy(aStep->GetTrack()->GetKineticEnergy());

  if(aStep->GetPreStepPoint()){
	newHit->SetPreKineticEnergy(aStep->GetPreStepPoint()->GetKineticEnergy());
  }
